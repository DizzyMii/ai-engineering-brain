...
**Every figure here moves fast, so each carries a date and a tier (E3 verified / E2 single credible source / E1 estimate / E0 speculation). Vendor and consultancy numbers never appear as fact.** Snapshot: 2026-07.
...
| HR / recruiting | Amazon (scrapped); Workday (litigated) | Amazon scrapped biased tool 2018; Mobley v. Workday collective certified 2025 | E3 / E2-E3⁷ | High-risk: avoid or gate |
...
1. **Klarna.** Launch numbers are Klarna/OpenAI's own (E2), and the $40M is an unaudited internal estimate. In May 2025 Klarna publicly walked back to AI-for-routine, humans-for-complex (E2/E3). See [[Breakdown - Klarna's AI Customer Service Bet]]. "700 agents" is a *workload* equivalence, not 700 people fired.
2. **Fin resolution.** 67% is Intercom's trailing-30-day vendor figure (as of late 2025). Independent reports and Intercom's own case studies put real-world resolution nearer 45–53% (E1/E2, third-party 2026). "$0.99/resolution" is real outcome pricing, but billable "outcomes" include *resolution, procedure handoff, or disqualification*, inflating the count against verified problem-solving: the "assumed resolution" critique in [[Lore - What Vendors Don't Say About Deflection Rates]].
...
6. **AI SDRs.** A March 2025 TechCrunch investigation alleged 11x listed non-customers as customers, counted trial contracts as ARR, and ran ~70-80% churn (E2, single investigation). Autonomous cold outbound is the worst fit for autopilot. See [[Concept - Vertical AI Agents by Function]].
7. **HR.** Amazon's scrapped tool is E3 (Reuters 2018). Mobley v. Workday advanced a novel *vendor-as-agent* discrimination theory; collective certified May 2025 (E2/E3). The EU AI Act classes employment AI as high-risk; the EU Digital Omnibus (agreed June 2026) deferred high-risk obligations from 2 Aug 2026 to 2 Dec 2027 but left the classification unchanged. See [[Breakdown - AI in Recruiting and HR Screening]].
8. **Khanmigo.** Khan Academy's own Nov 2024 efficacy report covers the *core Khan Academy platform* (~20% larger test-score gains at 30+ min/week), not Khanmigo; the post says Khanmigo-specific efficacy studies were "underway." The null result (significant gains across conditions, no statistically significant difference between groups) comes from a separate small 2025 study (Journal of Teaching and Learning, ~69 undergraduates, physics) comparing Khanmigo, a Google-search condition and paper-only (E2, single small study, 2025). No independently verified Khanmigo-specific RCT has surfaced as of mid-2026. See [[Breakdown - Khanmigo and AI Tutoring]].
