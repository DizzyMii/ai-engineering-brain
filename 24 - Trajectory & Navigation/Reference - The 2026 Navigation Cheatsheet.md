...
All rows date-stamped mid-2026. Tier per row, evidence-law style (E3 independently verified, E2 single credible source, E1 analyst/forecaster estimate, E0 speculation). It ages fast by design. Check dates before quoting.
...
| Support deflection, AI-in-the-loop | +14% issues/hr average, +34% for novices, ~0 for experts (Brynjolfsson-Li-Raymond RCT, 5,179 agents) | E3 | 2023/2025 | [[Breakdown - Klarna's AI Customer Service Bet]] shows the same pattern at company scale: it works, but not as a full headcount replacement (see Overhyped table) |
| Medical scribes | Modest, consistent time savings: 16 min/8hr saved documentation, 13 fewer min in EHR, ~1 extra patient/2 weeks across 1,800 clinicians, 5 academic centers, 2023-2025; a separate UCLA RCT found only ~41 sec/note reduction | E2/E3 | 2025-2026 | [[Breakdown - AI Medical Scribes]]; sold on burnout/well-being gains as much as raw time; don't expect dramatic throughput numbers |
| Content/marketing drafting | High adoption volume, but ROI not independently measured here; no RCT or named dollar figure backs this row | E1 | 2025-2026 | [[Reference - AI Impact by Business Function]]; adoption isn't evidence of profitability; treat as unquantified until a named study lands |
...
| GPT-4-class output pricing | ~$30/M (early 2023) → ~$0.40-0.80/M (2026), ~40-70x; don't conflate with the 1000x figure above, different capability bars | E1/E2, provider list prices + aggregator trackers, noisy | 2026 |
...
Design implication: build for supervised, checkable tasks scoped inside the 80% horizon, not the more-quoted 50% one. See [[Concept - METR Time Horizons]] and step 1 of [[Playbook - Picking Profitable AI Use Cases]].
...
| Expert survey median | 2047 (2023 survey), up from 2060 (2022 survey): a 13-year jump in one year, read as evidence surveys anchor to recent headlines (GPT-4 shipped between rounds) and not a stable model | E2, single survey series, response/selection bias | Grace et al. / AI Impacts, 2023 |
...
Four methods, four numbers, decades apart. Not a range to average. The pattern per [[Reference - The AI Forecasting Track Record]]: raw capability/scaling has historically been *under*-forecast (surveys revised earlier), and reliable open-ended autonomy and full job displacement *over*-forecast. The reliability-frontier rows above are evidence for the same asymmetry. Full spread and provenance weighting: [[Reference - The AI Forecasting Track Record]].
...
- Buy or wrap commodity capability instead of building it in-house. Same deflation math as above.
- All four survive both the bear and bull cases in [[Deep Dive - Bubble or Boom]], because they don't depend on which is true.
...
- Expect the cost-curve and reliability-frontier rows to be wrong within 6-12 months. Re-verify before using them in a funding decision.
